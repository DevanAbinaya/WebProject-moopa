...
function Navbar(props) {
    ...
    const renderThemeChanger = () => {
        ...
        if(currentTheme === 'dark') {
            return (
            <button onClick={() => setTheme('light')} className='md:p-2 md:ring-[0.5px] md:ring-orange-500 md:hover:bg-orange-500 md:rounded-md'>
                <svg width="25" height="25" viewBox="0 0 24 24" className='fill-white' fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            return (
                <button onClick={() => setTheme('dark')} className='md:p-2 md:hover:bg-orange-500 md:rounded-md'>
                <svg width="25" height="25" className='md:fill-black fill-[#8BA0B2]' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20.2097 15.32C19.6259 16.7062 18.6872 17.9141 17.488 18.8221C16.2888 19.7301 14.8716 20.3061 13.379 20.492C11.8864 20.678 10.3711 20.4673 8.98581 19.8813C7.60052 19.2953 6.39409 18.3546 5.48804 17.154C4.58198 15.9534 4.00828 14.5352 3.82473 13.0423C3.64117 11.5494 3.85423 10.0345 4.44245 8.65013C5.03067 7.26577 5.97328 6.06086 7.17536 5.15672C8.37743 4.25259 9.79652 3.68116 11.2897 3.49999C11.3933 3.48762 11.4982 3.50796 11.5896 3.55817C11.6811 3.60838 11.7545 3.68594 11.7997 3.77999C11.847 3.8723 11.8637 3.97721 11.8475 4.07964C11.8313 4.18207 11.7831 4.27672 11.7097 4.34999C11.0967 4.95809 10.6119 5.6829 10.2838 6.48158C9.95579 7.28026 9.79117 8.1366 9.79971 8.99999C9.80852 10.1348 10.1111 11.2481 10.6781 12.2312C11.245 13.2143 12.057 14.0338 13.0348 14.6098C14.0127 15.1859 15.123 15.4988 16.2578 15.5181C17.3925 15.5374 18.5128 15.2624 19.5097 14.72C19.6023 14.6722 19.7071 14.6534 19.8105 14.6658C19.9139 14.6783 20.0112 14.7216 20.0897 14.79C20.1566 14.8587 20.2033 14.9445 20.2245 15.0381C20.2456 15.1316 20.2405 15.2292 20.2097 15.32V15.32Z"/>
                </svg>
            </button>
            )
                ...
                {isVisible && (
                    ...
                    <div className='flex gap-7'>
                        <button className='flex flex-col items-center group'>
                            <Link href='/' className=''>
                            <svg width="28" height="24" viewBox="0 0 28 24" className='fill-[#8BA0B2] dark:fill-white group-hover:fill-cyan-700' fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button className='flex flex-col items-center group '>
                            <div>
                                <Link href='/gallery'>
                                <svg width="36" height="25" viewBox="0 0 36 25" className="fill-[#8BA0B2] dark:fill-white group-hover:fill-cyan-700" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <Link href='/gallery' className='font-karla font-bold text-[#8BA0B2] group-hover:text-cyan-700'>gallery</Link>
                        </button>
                    ...
                    <button onClick={handleHideClick}>
                        <svg width="20" height="21" className='fill-[#8BA0B2] dark:fill-orange-500' viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="2.44043" y="0.941467" width="23.5842" height="3.45134" rx="1.72567" transform="rotate(45 2.44043 0.941467)" />
                        <rect x="19.1172" y="3.38196" width="23.5842" height="3.45134" rx="1.72567" transform="rotate(135 19.1172 3.38196)" />
                        </svg>
                    </button>
                    </div>
                )}
