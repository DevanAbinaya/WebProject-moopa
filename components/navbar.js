...
function Navbar(props) {
    ...
    const renderThemeChanger = () => {
        ...
        if(currentTheme === 'dark') {
            return (
            <a onClick={() => setTheme('light')} className='md:p-2 md:ring-[0.5px] md:ring-orange-500 md:hover:bg-orange-500 md:rounded-md'>
            ...
            return (
                <a onClick={() => setTheme('dark')} className='md:p-2 md:hover:bg-orange-500 md:rounded-md'>
