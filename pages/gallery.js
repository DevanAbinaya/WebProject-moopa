        ...
        <>
          <Head>
            ...
            <link rel="icon" href="/c.svg" />
              ...
              <div>
                <Navbar className="nav md:transition-all md:duration-500 dark:bg-black bg-white bg-opacity-80 dark:bg-opacity-100 md:fixed md:top-0 z-50 w-screen h-16" />
      
                    <div className='flex justify-center md:pt-16 bg-[#F9F9F9] dark:bg-[#121212] md:justify-start pl-0 md:pl-32'>
