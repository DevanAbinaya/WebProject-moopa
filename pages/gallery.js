...
const MediaTypeSelector = ({selectedType, onChange}) => (
  <select value={selectedType} onChange={onChange} className="md:w-40 md:h-10 w-20 h-8 ring-gray-300 antialiased rounded-md text-center text-gray-800 dark:text-white transition-all duration-300 dark:bg-[#202020] ring-transparent shadow-sm">
