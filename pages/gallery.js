...
const MediaTypeSelector = ({ selectedType, onChange }) => (
  <select
    value={selectedType}
    onChange={onChange}
    className="h-8 w-20 rounded-md text-center text-gray-800 antialiased shadow-sm ring-gray-300 ring-transparent transition-all duration-300 dark:bg-[#1F1F1F] dark:text-white md:h-10 md:w-40"
  >
