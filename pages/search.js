...
const MediaTypeSelector = ({ selectedType, onChange }) => (
  <select
    value={selectedType}
    onChange={onChange}
    className="h-8 w-20 rounded-md text-center antialiased shadow-sm ring-gray-300 ring-transparent transition-all duration-300 bg-[#202020] text-white md:h-10 md:w-40"
  >
...
export default function Search() {
  ...
  return (
    <>
      ...
      <Layout>
        <div className=" flex w-screen pt-[8rem] transition-all duration-500 bg-[#121212] md:justify-center">
          <div className=" mx-5 flex w-screen flex-col justify-between gap-4 md:mx-0 md:w-[80%] md:flex-row">
            <input
              className="h-8 rounded-md text-center md:w-52 md:scale-100 bg-[#282828]"
        ...
        <main className="flex min-h-screen w-screen items-center justify-center transition-all duration-500 bg-[#121212]">
