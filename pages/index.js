    ...
    <>
      ...
      <Layout>
        <div className="antialiased pt-nav bg-gradient-to-br from-white via-white to-white dark:bg-gradient-to-br dark:from-slate-800 dark:to-slate-900">
          ...
          <section className="h-[100dvh] w-screen flex items-center justify-center">
              ...
              <h1 className="hidden text-5xl font-semibold md:flex gap-3 md:flex-row flex-col text-slate-700 dark:text-slate-300 cursor-default transition-all duration-700 text-center hover:gap-10 ">
                <div className="flex items-start flex-col gap-3">
                  <div className="flex gap-3">
                    <div>
                      DIVE INTO A NEW{" "}
                      <a className="bg-gradient-to-r from-[#7661FA] to-[#FF8990] animate-text bg-clip-text text-transparent">
                        WORLD
                      </a>
                    </div>
                  </div>
        ...
        <section
          id="firstp"
          className="xl:h-[54.25rem] xl:flex xl:items-center"
        >
          <div className="flex md:flex-row flex-col items-center md:mx-10 md:gap-3 xl:gap-52">
            <div className="flex flex-col md:gap-0 gap-10 md:text-2xl ">
              <h1 className="xl:mb-20 md:mb-16 md:text-4xl md:mt-0 mt-10 text-2xl pl-10 font-karla font-bold">
                Ini Web Apaan Sih?
              </h1>
              <p className="font-roboto md:mx-0 mx-5">
