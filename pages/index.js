...
const gif = 'https://tenor.com/view/emoji-smile-surprise-okay-thumbs-up-gif-14605208';
  ...
  return (
    <>
      ...
      <main className='w-screen'>
        ...
        <div className='antialiased bg-gradient-to-br from-white via-white to-white dark:bg-gradient-to-br dark:from-slate-800 dark:to-slate-900'>
        <Navbar className="text-black dark:bg-none dark:text-white md:px-5 md:pt-5 px-2 pt-2" />
          ...
          <section className='h-[59.06rem] w-screen flex items-center justify-center'>
            <div className='flex flex-col gap-y-20 md:pb-0 pb-32 md:-translate-y-14 -translate-y-0  justify-center items-center'>

            {/* Mobile*/}
            <h1 className='md:hidden text-5xl font-semibold flex gap-3 md:flex-row flex-col text-slate-700 dark:text-slate-300 cursor-default transition-all duration-500'>
