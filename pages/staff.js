                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex gap-5">
                                        <div className="tooltip relative inline-block">
                                            ...
                                            <path d="M22.5508 22V26L32.7005 16L22.5508 6V10L28.6406 16L22.5508 22Z" className="fill-black dark:fill-white"/>
                                            <path d="M10.3704 22V26L0.220703 16L10.3704 6V10L4.2806 16L10.3704 22Z" className="fill-black dark:fill-white"/>
                                            <path d="M10.3711 20H14.431L22.5508 12H18.4909L10.3711 20Z" className="fill-black dark:fill-white"/>
                                            </g>
                                            <defs>
                                            <clipPath id="clip0_292_346">
                                            <path d="M0.220703 10C0.220703 4.47715 4.69786 0 10.2207 0H22.6999C28.2227 0 32.6999 4.47715 32.6999 10V22C32.6999 27.5228 28.2227 32 22.6999 32H10.2207C4.69785 32 0.220703 27.5228 0.220703 22V10Z" className="fill-white dark:fill-black"/>
                                            </clipPath>
                                            </defs>
                                            </svg>
                                            <span className="tooltiptext absolute bottom-10 -right-12 py-2 px-4 text-center w-max bg-[#18191c] text-sm text-slate-200 rounded-md font-semibold transition-all duration-300 ease-out">Lead Developer</span>
                                        </div>
                                        <div className="tooltip relative inline-block">
                            ...
                            <div className="xl:w-[38rem] h-auto flex flex-col xl:px-[40px] xl:pb-[40px] pb-[30px] px-[30px] pt-5 bg-white dark:bg-[#212121] shadow-md rounded-b-[10px] gap-8">
                                ...
                                {post.tags && 
                                    ...
                                    <div className="tooltip relative inline-block">
                                        ...
                                        <span className="tooltiptext absolute bottom-10 py-2 px-4 text-center w-max bg-[#18191c] text-sm text-slate-200 rounded-md font-semibold transition-all duration-300 ease-out">{post.tags.dev}</span>
                                        </div>}
                                    ...
                                    <div className="tooltip relative inline-block">
                                        ...
                                        <span className="tooltiptext absolute bottom-10 -right-14 py-2 px-4 text-center w-max bg-[#18191c] text-sm text-slate-200 rounded-md font-semibold transition-all duration-300 ease-out">{post.tags.moral}</span>
                                        </div>}
                                    ...
                                    <div className="tooltip relative inline-block">
                                        ...
                                        <span className="tooltiptext absolute bottom-10 -right-11 py-2 px-4 text-center w-max bg-[#18191c] text-sm text-slate-200 rounded-md font-semibold transition-all duration-300 ease-out">{post.tags.design}</span>
                                        </div>
                                    }
